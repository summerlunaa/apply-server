...
const onScroll = ()=>{
	...
	if( currentY >= 0 && currentY<=lastHeight/5){
        console.log(1);
        title.style.transform =`translate(${40-40*currentY/lastHeight*5}rem,${20-20*currentY/lastHeight*5}rem) scale(${550 - 450*(currentY/lastHeight*5)}%) ` ;
	...
	}else if(currentY > lastHeight/5*2 && currentY<= lastHeight/5*3){
        console.log(3);
	...
	}else if(currentY > lastHeight/5*3 && currentY<= lastHeight/5*4){
		console.log(4);
